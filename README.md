...
2. **Starting with 6 checks**: prioritized by CVSS severity + frequency in real-world breaches. Public S3 + root key = responsible for majority of high-profile cloud incidents.
...
- [ ] IAM password policy enforcement (CIS 1.8–1.11)
- [ ] Public RDS instance detection
- [ ] Unused IAM access keys (>90 days)
